# Installation Script for Odoo 18.0 on Ubuntu 24.04 LTS
...
```
wget https://raw.githubusercontent.com/wizard-technolab/odoo18/18.0/install_odoo_ubuntu.sh
```
...
```OE_VERSION``` is the Odoo version to install, for example ```18.0``` for Odoo V18.<br/>
...
For more information please reach out us on,
Website: [Warlock Technologies](https://www.warlocktechnologies.com/)
